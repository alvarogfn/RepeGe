...
enum DnDDamage {
  ...
  necrotic(name: 'Necrótico', color: Color.fromRGBO(255, 255, 0, 1)),
  poison(name: 'Veneno', color: Color.fromRGBO(255, 255, 0, 1)),
  psychic(name: 'Psíquico', color: Color.fromRGBO(255, 255, 0, 1)),
  radiant(name: 'Radiante', color: Color.fromRGBO(255, 255, 255, 1)),
  slashing(name: 'Corte', color: Color.fromRGBO(139, 0, 0, 1)),
  thunder(name: 'Trovão', color: Color.fromRGBO(139, 0, 0, 1));
